...
<div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<!--<img src="assets/admin//img/logo-light.png" alt="logo" class="logo-default"/>-->
			</a>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark">
						<form action="controllers/authenticationController.php" method="POST" class="form-inline margin-bottom-40" role="form">
							<div class="form-group form-md-line-input has-error">
								<div class="input-icon">
									<input name="email" type="text" class="form-control" placeholder="Login">
									<div class="form-control-focus">
									</div>
									<span class="help-block">Digite seu login</span>
							...
							<p align="right"><a align="right" data-toggle="modal" data-target="#modalEsqueciSenha">Esqueci minha senha</a></p>
							<div class="modal fade" id="modalEsqueciSenha">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&imes;</span></button>
                                            <h2 class="modal-title"><b>Esqueceu sua senha?</b></h2>
                                        </div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="portlet light">
						<div class="portlet-title">
							<div id="carousel" class="carousel slide" data-ride="carousel"><!-- inicio carousel-->
								...
								<div class="carousel-inner" role="listbox"><!--Carousel Inner-->
									<div class="item active">
										<img src="content/img/banner1.jpg" alt="">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-red-sunglo bold uppercase">Como funciona?</span>
							</div>
						</div>
						<div class="dashboard-stat2">
							<img src="content/img/quadrinho.jpg" alt="" style="width:100%;"/>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="portlet light ">
						<!-- BEGIN PORTLET-->
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-bubble font-red-sunglo"></i>
									<span class="caption-subject font-red-sunglo bold uppercase">Por que fazemos isso?</span>
								</div>
							</div>
							<div class="portlet-body" id="chats">
								<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 243px;"><div class="scroller" style="height: 353px; overflow: hidden; width: auto;" data-always-visible="1" data-rail-visible1="1" data-initialized="1">
									<ul class="chats">
										<li class="in">
				...
				<div class="col-md-6 col-sm-12">
					...
					<div class="portlet light tasks-widget">
						<div class="portlet-title">
							<div class="caption caption-md">
								<i class="icon-bar-chart theme-font-color hide"></i>
								<span class="caption-subject theme-font-color bold uppercase">Quer ser um Doador ou Voluntário?</span>
							</div>
						</div>
						<div class="portlet-body">
							<div class="task-content">
								<div class="scroller" style="height: 116px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
									<a class="dashboard-stat dashboard-stat-light blue-soft" href="cadastroDoador.html">
										<div class="visual">
				...
				<div class="col-md-6 col-sm-12">
					...
					<div class="portlet light tasks-widget">
						<div class="portlet-title">
							<div class="caption caption-md">
								<i class="icon-bar-chart theme-font-color hide"></i>
								<span class="caption-subject theme-font-color bold uppercase">Voçê é um assistente social e quer participar?</span>
							</div>
						</div>
						<div class="portlet-body">
							<div class="task-content">
								<div class="scroller" style="height: 116px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
									<a class="dashboard-stat dashboard-stat-light purple-soft" href="cadastroAssistente.html">
										<div class="visual">
											<i class="fa fa-trophy"></i>
										</div>
										<div class="details">
